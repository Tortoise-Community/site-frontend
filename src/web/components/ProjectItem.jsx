...
export default function ProjectItem({ data, loading }) {
  return (
    <div className="card pt-md-3 px-md-2 pb--3 w-100">
      {!loading ? (
        <div>
          <a className="stretched-link" href={data.github}>
            <h5 className="card-header bg-transparent">
              <i className="fab fa-github" /> {data.name}
            </h5>
          </a>
          ...
          <div className="card-footer bg-transparent mb--3">
            <ul className="list-inline">
              ...
              <li className="list-inline-item">
                <i className="fa fa-code-fork" /> {data.forks}
              </li>
              <li className="list-inline-item">
                <i className="fa fa-history" /> {data.commits}
              </li>
            </ul>
          </div>
        </div>
